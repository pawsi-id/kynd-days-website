...
export function WhatsAppButton() {
  ...
  const whatsappUrl = `https://wa.me/${branches[0].whatsapp}?text=${encodeURIComponent(
    'Halo Kynd Days! Saya ingin bertanya tentang layanan massage.'
  )}`;
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-white shadow-lg rounded-lg px-4 py-2 text-sm text-primary font-medium">
          Chat dengan kami
      ...
      <a
        ...
        className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20BA5C] rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 group"
      >
